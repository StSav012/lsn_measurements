...
class DetectGUI(QMainWindow):
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        self.setWindowTitle(self.tr("Detect"))
        ...
        self.stop_key_pulse_duration: QPushButton = QPushButton(self.stop_sings_box)
    ...
    def setup_ui_appearance(self) -> None:
        ...
        self.stop_key_pulse_duration.setText(self.tr("Stop after this Pulse Duration"))
        self.stop_key_setting_time.setText(self.tr("Stop after this Setting Time"))
        self.stop_key_delay_between_cycles.setText(self.tr("Stop after this Delay b/w Cycles"))
        ...
        self.stop_key_pulse_duration.setCheckable(True)
        ...
        self.stop_sings_box.layout().addWidget(self.stop_key_pulse_duration)
